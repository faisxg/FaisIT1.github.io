...
// Skriv koden din her:
const flereEnnTre = ordbok.filter(klasser => klasser.ordklasser.length >= 3)
console.table(flereEnnTre)
...
// Skriv koden din her:
const popOver85 = ordbok.find(ord => ord.popularitet > 85)
console.table(popOver85)
...
// Skriv koden din her:
const orda = ordbok.map(ord => ord.ord);
console.table(orda)
...
// Skriv koden din her:
const ordOgKlasse = ordbok.map(ord => ({"ord": ord.ord, "antallOrdklasser": ord.ordklasser.length}));
console.table(ordOgKlasse)
